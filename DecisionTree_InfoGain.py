...
if __name__ == '__main__':
    ...
    #Initialize the Decision Tree classifier with information gain
    clf_entropy = DecisionTreeClassifier(criterion = "entropy",  max_depth=7, min_samples_leaf=5)
    
    # Train the information gain Decision Tree
    clf_entropy.fit(X, Y)
    ...
    for _ in range(num_games_test):
        ...
        while not finished:
            ...
            preds_W_hit = clf_entropy.predict_proba([outc_W_hit])   #order of this output is [-1  0  1] thanks to mnb.classes_ attribute output
